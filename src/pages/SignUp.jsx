...
const SignUp = () => {
  ...
  return (
    <section className="relative w-full md:min-h-screen min-h-160 max-sm:min-h-screen overflow-hidden px-5 md:px-22 max-sm:px-4 flex items-center font-Manrope">
      {/* background */}
      <div
      ...
      {/* logo */}
      {/* <div className="absolute top-4 left-4 max-sm:top-9 max-sm:left-5 z-10 group">
        <Link to="/">
          <Button
            variant=""
            className="h-9 max-sm:h-fit w-fit flex justify-between gap-0 group-hover:gap-2 text-white rounded-full pr-1 group-hover:pr-5 pl-1 max-sm:py-1 bg-white/6 backdrop-blur-lg backdrop-saturate-100 border border-white/30 transition-all duration-300 ease-in-out overflow-hidden"
          >
            <div className="h-7 w-7 max-sm:h-10 max-sm:w-10 rounded-full bg-white shrink-0 flex items-center justify-center">
              <ArrowUpLeft className="h-4 w-4 max-sm:h-6 max-sm:w-6 duration-500 ease-in-out transition-transform group-hover:-rotate-45 text-black" />
            </div>
            <span className="max-w-0 group-hover:max-w-20 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out overflow-hidden whitespace-nowrap">
              Back
            </span>
          </Button>
        </Link>
      ...
      {/* back btn  */}
      <Link to="/" className="absolute top-4 left-3 z-10 h-9 w-fit max-sm:left-7 max-sm:top-8 text-white">
        ...
        <div className="relative z-10 text-gray-200">
          <CardHeader className="text-left max-sm:px-5 max-sm:pt-6">
            ...
            <CardDescription className="text-gray-200/80 max-sm:text-sm">
              Yooo, welcome aboard 🔥
              <br /> Good vibes, sweaty sessions, and zero excuses.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="mt-6 max-sm:mt-4 max-sm:px-5">
            <form>
              <div className="flex flex-col gap-5 max-sm:gap-3.5">
                ...
                <div className="grid gap-2 text-white">
                  <Label htmlFor="confirm-password" className="max-sm:text-sm">
                    Confirm Password
                  </Label>
                  <div className="relative">
                    <Input
